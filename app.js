// Datos de tareas — VERSIÓN CORREGIDA
const tasksData = {
  '2026-06-05': {
  ...
  '2026-06-09': {
    title: 'RECIBIR CÁMARAS',
    date: 'Martes 9 de junio',
    isEvent: false,
    items: [
      { text: 'Recibir las cámaras desechables de los 5 perfiles', responsible: 'Pau' },
      { text: 'Verificar que todas estén en buen estado y funcionando', responsible: 'Pau' }
    ]
  },
  '2026-06-10': {
    title: 'ENVIAR A REVELAR',
    date: 'Miércoles 10 de junio',
    isEvent: false,
    items: [
      { text: 'Mandar las cámaras a revelar', responsible: 'Pau' },
      { text: 'Confirmar fecha y hora de entrega de fotos reveladas', responsible: 'Pau' }
    ]
  },
  '2026-06-12': {
    ...
    items: [
      ...
      { text: 'Tener las piezas de pauta listas', responsible: 'Paula' },
      { text: 'Comprar los implementos necesarios para el evento', responsible: 'Andrés' },
      { text: 'Confirmar al fotógrafo/videógrafo para el evento', responsible: 'Pau' },
...
const reminders = [
  ...
  { date: '2026-06-09', time: '09:00', message: '📷 HOY recibimos las cámaras desechables. Verifica que todas estén en buen estado.' },
  { date: '2026-06-10', time: '09:00', message: '🎬 HOY enviamos las cámaras a revelar. Confirma la fecha de entrega.' },
  { date: '2026-06-12', time: '09:00', message: '⏰ 1 SEMANA para Vigilia!\n\nChecklist:\n✓ E-commerce listo\n✓ Parrilla de contenido\n✓ Piezas de pauta\n✓ Implementos comprados\n✓ Fotógrafo/videógrafo confirmado\n\n¡Vamos!' },
      ...
      return `
        <div class="task-item ${isDone ? 'done' : ''}">
          ...
          <div>
            ...
            <div class="task-responsible">👤 ${t.responsible}</div>
          </div>
        </div>
      `;
    }).join('');
...
function updateStats() {
  ...
  const eventDate = new Date(2026, 5, 19);
